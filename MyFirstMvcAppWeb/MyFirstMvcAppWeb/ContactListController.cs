...
namespace MyFirstMvcAppWeb
{
    ...
    {
        private readonly MyFirstMvcAppWebContext _context;

        public ContactListController(MyFirstMvcAppWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ContactType,Name,Phone,Email")] ContactListEntry contactListEntry)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ContactType,Name,Phone,Email")] ContactListEntry contactListEntry)
        {
